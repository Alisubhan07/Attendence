...
#bg image ................
        ...
        main_frame.place(x=0,y=20,width=1360,height=600)


        #left lable frame................
        left_frame=LabelFrame(main_frame,bd=2,bg='white', relief= RIDGE,text="STUDENT DETAILS",font=("times new roman",12,"bold"))
        left_frame.place(x=10,y=10,width=1030,height=580)
...
#button frames ..............................
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_data,text="TAKE PHOTO SAMPLE",width=35,font=("times new roman",12,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0)

        update_photo_btn=Button(btn_frame1,command=self.update_data,text="UPDATE PHOTO SAMPLE",width=35,font=("times new roman",12,"bold"),bg="blue",fg="white")
        update_photo_btn.grid(row=0,column=1)


        #RIGHT lable frame................
        right_frame=LabelFrame(main_frame,bd=2,bg='white', relief= RIDGE,text="STUDENT DETAILS",font=("times new roman",12,"bold"))
        right_frame.place(x=600,y=10,width=820,height=580)


        search_frame=LabelFrame(right_frame,bd=2,bg="white",relief=RIDGE,text="SEARCH",font=("times new roman",12,"bold"))
        search_frame.place(x=5,y=0,width=720,height=530)
